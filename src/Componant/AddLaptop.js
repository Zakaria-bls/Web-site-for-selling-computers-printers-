...
export default function AddLaptop() {
  ...
  const handleClick = (e) => { 
    ...
    if(allData.Poursantage.trim()==="" || allData.Brand.trim()==="" || allData.Description.trim()==="" || allData.FicheTechnique.trim()==="" || allData.Generation.trim()==="" || allData.Prix.trim()==="" || allData.Processeur.trim()==="" || allData.Model.trim()===""){
        ...
        <div className='elementsLigne'>
          <div className='imputContainer'>
            <div className='insideInput'>   
                <p className='textInput'>Processeur</p>
                <input placeholder='Ex: I7' type='text' name='Processeur' value={allData.Processeur} onChange={handleInputChange}/>
            </div>
            <div className='insideInput'>   
                <p className='textInput'>Generation</p>
                <input placeholder='Ex: 10em' type='text' name='Generation' value={allData.Generation} onChange={handleInputChange}/>
            </div>
          </div>
          <div className='imputContainer'>
